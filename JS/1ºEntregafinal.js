//falta colocar imagenes y generar cards en el css para los productos, falta añadir dom a la calculadora. 
...
function submitForm(e){
    ...
    li.innerHTML = `${inputNombre.value}`
    ...
    localStorage.setItem('productos', JSON.stringify(listaP));
    form.reset();
}
